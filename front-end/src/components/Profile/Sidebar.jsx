...
const Sidebar = ({data}) => {
  return (
    <div className='bg-zinc-800 p-4 rounded-md flex flex-col items-center justify-between h-[90%]'>
      ...
      <button className=' w-3/6 lg:w-full mt-4 lg:mt-0  font-semibold flex items-center justify-center text-red-500 transition-all duration-300 bg-zinc-900 py-3 rounded-md hover:bg-red-700 hover:text-white'>
        Log Out
